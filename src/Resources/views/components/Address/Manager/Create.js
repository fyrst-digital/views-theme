 ...
 */
export default class AddressManagerCreate extends ShopwareComponent {
    static options = {
        type: 'shipping',
    ...
    _onClick(event) {
        ...
        getInstanceByElement(this.options.managerComponent, root)?.openCreate?.(this.options.type)
    }
}
