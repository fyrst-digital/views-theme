...
description: Specialized Shopware 6.7 developer for theme customization, storefront features, and general plugin architecture. Use proactively for all code-level Shopware tasks (Twig/UX components, storefront JS, SCSS, CMS, services, migrations).
model: inherit
---
...
| **Plugin base class** | `Fyrst\ViewsTheme\ViewsTheme` |
...
- **PSR-12** / Shopware coding standards; namespace `Fyrst\ViewsTheme`
