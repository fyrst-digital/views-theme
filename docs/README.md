...
- [Product reviews](features/review.md)
- [Tabs](features/tabs.md)
- [Accordion](features/accordion.md)
...
- **Account / Address / Order** — address-book **listing** page owner and order history (register/address forms: [checkout-register](features/checkout-register.md); confirm picker + editor: [address manager](features/address-manager.md); header login: [account-action](features/account-action.md))
